...
public class frmCrearArchivo extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnLeerArchivo.setText("LeerArchivo");
    ...
    private void btnCrearArchivoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCrearArchivoActionPerformed
        ...
        //llama una funcion que crea un documento txt, se envian(nombredocumento,contenido)
        PManejoDocumento funciones = new PManejoDocumento();
        funciones.crearDocumentoTxt("mirar",contenido);
    ...
    private void btnLeerArchivoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLeerArchivoActionPerformed
        ...
        PManejoDocumento funciones = new PManejoDocumento();
        String texto= funciones.leerDocumentoTxt("mirar");
        JOptionPane.showMessageDialog(null,"El texto completo es:\n"+texto);
